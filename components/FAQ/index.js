...
export default function FAQ() {
  const categories = [
    {
      ...
      faqs: [
        ...
        {
          question: '大家都好強，我怕我做的東西沒有達到過關門檻，不敢登錄作品',
          answer: '這個活動並非競爭性質，每個參賽者都是你的隊友，最大的敵人是你自己，因為你必須定期練功前端開發，讓自己能夠順利完賽。',
        },
        {
          question: '我不確定自己做的版型有沒有符合過關門檻，要寫到什麼程度才有到過關門檻？',
    ...
    },
    {
      ...
      faqs: [
        {
          question: '到時投稿到平台是提供什麼呢？我也不像是工程師可以有 CODEPEN 上傳。',
    ...
    },
    {
      ...
      faqs: [
        {
          question: '我可以不依照設計稿，自己做版面嗎？因為我想多練習 JS / 後端',
  ...
  const getFaqs = () => (
    categories.find(({ name }) => name === selectedCategory).faqs
  )

  const [selectedQuestion, setSelectedQuestion] = useState(null);
  const handleSelectedQuestion = (newQuestion) => {
    if (newQuestion === selectedQuestion) {
          ...
          getFaqs().map((faq) => (
            ...
            >
              <div className={styles.question}>
                ...
                <Image src="./assets/expand.png" alt="expand" width={16} height={16} />
              </div>
              {
