  ...
  return (
    <div className={styles.container}>
      <div
        ...
        style={zIndexTop}
      >
        <Image src={css3} alt="css3" width={42} height={42} />
      </div>
      <div
        className={`${styles.skillIcon} ${styles.absolute}`}
        style={{ left: '74%', top: 140, ...zIndexTop }}
      >
        <Image src={html5} alt="html5" width={42} height={42} />
      </div>
      <div
        className={`${styles.skillIcon} ${styles.absolute}`}
        style={{ left: '85.5%', top: 40, ...zIndexTop }}
      >
        <Image src={xd} alt="xd" width={42} height={42} />
      </div>
      <div
        className={`${styles.skillIcon} ${styles.absolute}`}
        style={{ left: '96.5%', top: 296, ...zIndexTop }}
      >
        <Image src={js} alt="js" width={42} height={42} />
      </div>
      <div
        className={`${styles.skillIcon} ${styles.absolute}`}
        style={{ left: '12.5%', top: 300, ...zIndexTop }}
      >
        <Image src={figma} alt="figma" width={42} height={42} />
      </div>
      <Image
        src={dashed1}
        alt="dashed1"
