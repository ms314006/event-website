  ...
  return (
    <>
      ...
      <div className={styles.mobileContainer}>
        <SkillIconWrap backgroundColor="#beb596" width='10rem' height='10rem'>
          <Image src="./assets/video.png" alt="video" width={90} height={90} />
        </SkillIconWrap>
        <Shade
          color="#ffffff"
          shadowColor="#beb596"
          shadowTop="1rem"
          contentPadding="1rem 3rem"
          customStyles={{ margin: '1rem 0 3rem 0' }}
        >
          <span className={styles.title}>羨慕別人的酷酷網頁動畫?</span>
        </Shade>
        <SkillIconWrap backgroundColor="#8fb5d0" width='10rem' height='10rem'>
          <Image src="./assets/idea.png" alt="idea" width={70} height={90} />
        </SkillIconWrap>
        <Shade
          color="#ffffff"
          shadowColor="#8fb5d0"
        ...
        <SkillIconWrap backgroundColor="#bf9d96" width='10rem' height='10rem'>
          <Image src="./assets/tree.png" alt="tree" width={90} height={90} />
        </SkillIconWrap>
        <Shade
          color="#ffffff"
          shadowColor="#bf9d96"
